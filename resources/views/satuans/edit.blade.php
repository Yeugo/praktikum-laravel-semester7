            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            <form action="{{ route('satuans.update',$satuan->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('simbol') is-invalid @enderror" name="simbol" 
                                    value="{{old('simbol', $satuan->simbol) }}" placeholder="Masukkan Simbol(kg, pcs, u, dll)">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    value="{{old('deskripsi', $kategori->deskripsi) }}" placeholder="Masukkan Deskripsi">
